...
import swen.monopoly.Property;
import swen.monopoly.Street;
...
public class TextClient {
  ...
  /*
   * ============================================================== Funny how the
   * following all look like use cases ... or is it ?
   * ==============================================================
   */
  ...
  private static void buyProperty(Player player, GameOfMonopoly game) throws GameOfMonopoly.InvalidMove {
    ...
    System.out.println(
        player.getName() + " purchased " + location.getName() + " from bank for $" + ((Property) location).getPrice());
  ...
  private static void playerOptions(Player player, GameOfMonopoly board) {
    System.out.println(player.getName() + " has $" + player.getBalance() + " remaining.\n");
  ...
  public static void main(String args[]) {
    ...
    ArrayList<Player> players = inputPlayers(nplayers, game.getBoard().getStartLocation());
    ...
    while (1 == 1) { // loop forever
      ...
      for (Player player : players) {
        ...
        if (player.getBalance() < 0) {
          ...
          System.out.println("\n Game over for " + player.getName() + " --- insufficient funds!");
